# Borrowed from branch ekko-lens (research/ekko/harness.py), commit 89ae076, 2026-09-16.
# Exact-replay harness for Qwen3.6-27B: forward_from(h, layer) verified to 0.000e+00 error on this
# architecture (ekko-lens FINDINGS F0.1). Kept verbatim; changes must be logged in CLAUDE.md.
