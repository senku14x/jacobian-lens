# Borrowed from branch ekko-lens (research/ekko/rules.py), commit 89ae076, 2026-09-16.
# Forward-preserving stop-gradient surrogates (LRP rules) for Qwen3_5 blocks; source-verified there.
# Used only for the R-lens arm. Known cosmetic issues noted in ekko FINDINGS F10.1.
